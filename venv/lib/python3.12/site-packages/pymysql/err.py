...
class Error(MySQLError):
    """Exception that is the base class of all other errors exceptions
    (not Warning)."""
...
class OperationalError(DatabaseError):
    ...
    errors occurred during processing, etc."""
...
class InternalError(DatabaseError):
    ...
    errors, e.g. the cursor is not valid anymore, the transaction is
    out of sync, etc."""


class ProgrammingError(DatabaseError):
    """Exception raised for programming errors, e.g. table not found
    or already exists, syntax errors in the SQL statement, wrong number
