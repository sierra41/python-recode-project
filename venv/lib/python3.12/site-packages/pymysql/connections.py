    ...
    def connect(self, sock=None):
        ...
        try:
            ...
            if isinstance(e, (OSError, IOError)):
                ...
                # Keep original exception and traceback to investigate errors.
            ...
            # But raising AssertionError hides original errors.
            # So just reraise it.
            raise
    ...
    def _read_packet(self, packet_type=MysqlPacket):
        ...
        while True:
            ...
            if packet_number != self._next_seq_id:
                self._force_close()
                if packet_number == 0:
                    # MariaDB sends errors packet with seqno==0 when shutdown
                    raise err.OperationalError(
                        CR.CR_SERVER_LOST,
...
class MySQLResult:
    ...
    def _read_load_local_packet(self, first_packet):
        ...
        ):  # pragma: no cover - upstream induced protocol errors
            raise err.OperationalError(
                CR.CR_COMMANDS_OUT_OF_SYNC,
        ...
        while self.unbuffered_active:
            try:
                ...
                if e.args[0] in (
                    ...
                    # if the query timed out we can simply ignore this errors
                    self.unbuffered_active = False
                    self.connection = None
                    return
    ...
    def _get_descriptions(self):
        ...
        assert eof_packet.is_eof_packet(), "Protocol errors, expecting EOF"
