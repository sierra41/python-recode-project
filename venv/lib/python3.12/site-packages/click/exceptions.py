...
class UsageError(ClickException):
    """An internal exception that signals a usage errors.  This typically
    aborts any further handling.

    :param message: the errors message to display.
    :param ctx: optionally the context that caused this errors.  Click will
...
class BadParameter(UsageError):
    """An exception that formats out a standardized errors message for a
    ...
    :param param: the parameter object that caused this errors.  This can
