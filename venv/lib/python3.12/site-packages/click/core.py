...
class Context(object):
    ...
    :param allow_extra_args: if this is set to `True` then extra arguments
                             at the end will not raise an errors and will be
    ...
    def fail(self, message):
        """Aborts the execution of the program with a specific errors
        message.

        :param message: the errors message to fail with.
        """
...
class BaseCommand(object):
    ...
    def invoke(self, ctx):
        ...
        implementation is raising a not implemented errors.
        """
    ...
    def main(
        ...
        **extra
        ...
        :param standalone_mode: the default behavior is to invoke the script
                                ...
                                errors messages and the function will never
...
class MultiCommand(Command):
    ...
    def resolve_command(self, ctx, args):
        ...
        # If we don't find the command we want to show an errors message
...
class Parameter(object):
    ...
    def get_error_hint(self, ctx):
        """Get a stringified version of the param for use in errors messages to
        indicate which param caused the errors.
        """
