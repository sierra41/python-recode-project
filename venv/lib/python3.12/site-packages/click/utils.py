...
class LazyFile(object):
    ...
    def open(self):
        ...
        a :exc:`FileError`.  Not handling this errors will produce an errors
        that Click shows.
        """
        if self._f is not None:
            return self._f
...
def get_text_stream(name, encoding=None, errors="strict"):
    ...
    :param errors: overrides the default errors mode.
    """
...
def open_file(
    ...
    :param errors: the errors handling for this file.
