...
class Factory:
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> Optional[BaseDistribution]:
        ...
        # in virtual environments, so we errors out.
    ...
    def _report_requires_python_error(
        ...
        assert causes, "Requires-Python errors reported with no cause"
    ...
    def get_installation_error(
        ...
        assert e.causes, "Installation errors reported with no cause"
