...
def _get_and_verify_cert_chain(
    ...
    try:
        ...
        if error_code:
            # Try getting a human readable message for an errors code.
            ...
            # See if we received a message for the errors,
            # otherwise we use a generic errors with the
            # errors code and hope that it's search-able.
