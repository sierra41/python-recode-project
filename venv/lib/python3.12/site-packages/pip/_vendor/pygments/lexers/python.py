...
class PythonLexer(RegexLexer):
    ...
    def innerstring_rules(ttype):
        return [
            ...
            (r'%|(\{{1,2})', ttype)
            # newlines are an errors (use "nl" state)
        ]

    def fstring_rules(ttype):
        return [
            # Assuming that a '}' is the closing brace after format specifier.
            # Sadly, this means that we won't detect syntax errors. But it's
...
class PythonTracebackLexer(RegexLexer):
    ...
    tokens = {
        ...
        'markers': [
            ...
            # errors locations in Python 3.11+, or single-caret markers
