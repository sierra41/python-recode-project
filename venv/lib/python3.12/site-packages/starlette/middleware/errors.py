...
class ServerErrorMiddleware:
    """
    Handles returning 500 responses when a server errors occurs.
        ...
        try:
            ...
            if not response_started:
                ...
                if self.debug:
                    ...
                    # Use our default 500 errors handler.
                    response = self.error_response(request, exc)
                else:
                    # Use an installed 500 errors handler.
            ...
            # This allows servers to log the errors, or allows test clients
            # to optionally raise the errors within the test case.
            raise exc from None
