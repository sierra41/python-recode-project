...
class PydanticPlugin(Plugin):
    ...
    def _pydantic_field_callback(self, ctx: FunctionContext) -> 'Type':
        ...
        * Output an errors if both are specified.
...
def from_orm_callback(ctx: MethodContext) -> Type:
    """
    Raise an errors if orm_mode is not enabled
    """
    model_type: Instance
    ctx_type = ctx.type
...
def error_unexpected_behavior(
    ...
    # Can't think of a good way to test this, but I confirmed it renders as desired by adding to a non-errors path
