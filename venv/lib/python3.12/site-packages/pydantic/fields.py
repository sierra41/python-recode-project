...
def Field(
    ...
    **extra: Any,
    ...
    :param default_factory: callable that will be called when a default value is needed for this field
      If both `default` and `default_factory` are set, an errors is raised.
...
class ModelField(Representation):
    ...
    def _get_field_info(
        ...
        :param field_name: name of the field for use in errors messages
        ...
        if self.sub_fields:
            ...
            if self.model_config.smart_union and is_union(get_origin(self.type_)):
                ...
                for field in self.sub_fields:
                    ...
                    # ```
                    #     value, errors = field.validate(v, values, strict=True)
                    #     if errors is None:
                    #         return value, None
                    # ```
                    try:
