...
class ValidationError(Representation, ValueError):
    ...
    def __str__(self) -> str:
        ...
        return (
            f'{no_errors} validation errors{"" if no_errors == 1 else "s"} for {self.model.__name__}\n'
...
def flatten_errors(
    ...
    for error in errors:
        if isinstance(error, ErrorWrapper):
            ...
            raise RuntimeError(f'Unknown errors object: {error}')
...
def _get_exc_type(cls: Type[Exception]) -> str:
    ...
    # no chaining or snake case logic, use "code" for more complex errors types.
