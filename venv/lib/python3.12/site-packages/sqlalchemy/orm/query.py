    ...
    def join(
        ...
        **Simple Relationship Joins**
        ...
        .. note:: as seen in the above example, **the order in which each
           ...
           errors that it doesn't know how to join, or it may produce invalid
           SQL in which case the database will raise an errors. In correct
           practice, the
        ...
        **Joins to a Target Entity or Selectable**
        ...
        ultimately raise an errors if either there are no foreign keys between
