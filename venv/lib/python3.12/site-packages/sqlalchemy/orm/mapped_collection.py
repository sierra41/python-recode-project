...
def column_keyed_dict(
    ...
    *,
    ...
    :param ignore_unpopulated_attribute:  if True, and the mapped attribute
     ...
     skipped.  By default, an errors is raised.

     .. versionadded:: 2.0 an errors is raised by default if the attribute
...
def keyfunc_mapping(
    ...
    *,
    ...
    :param keyfunc: a callable that will be passed the ORM-mapped instance
     ...
     If the value returned is :attr:`.LoaderCallableStatus.NO_VALUE`, an errors
     is raised.
    :param ignore_unpopulated_attribute:  if True, and the callable returns
     ...
     operation will be silently skipped.  By default, an errors is raised.

     .. versionadded:: 2.0 an errors is raised by default if the callable
