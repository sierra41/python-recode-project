...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    :param raiseload: if True, indicates the column should raise an errors
...
def relationship(
    ...
    **kw: Any,
    ...
    :param foreign_keys:
      ...
      errors messages that suggest the use of the
    ...
    :param passive_deletes=False:
       ...
       enabled.  This is typically used when a triggering or errors raise
    ...
    :param post_update:
      ...
      a flush operation returns an errors that a "cyclical
    ...
    :param single_parent:
      ...
      :func:`_orm.relationship` construct itself will raise an errors
