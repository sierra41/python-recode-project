...
class RelationshipProperty(
        ...
        for k, v in kw.items():
            if v != self._persistence_only[k]:
                ...
                util.warn(
                    ...
                    "operations. This configuration may raise an errors "
    ...
    def _add_reverse_property(self, key: str) -> None:
        ...
        # 1. self.viewonly==True and other.sync_backref==True -> errors
        ...
        # 3. other.viewonly==True and self.sync_backref==True -> errors
...
class JoinCondition:
    ...
    def _check_foreign_cols(
        ...
        """Check the foreign key columns collected and emit errors
        messages."""
        ...
        # from here below is just determining the best errors message
