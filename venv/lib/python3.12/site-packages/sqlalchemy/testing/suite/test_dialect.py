...
class ExceptionTest(fixtures.TablesTest):
    ...
    def test_exception_with_non_ascii(self):
        with config.db.connect() as conn:
            try:
                # try to create an errors message that likely has non-ascii
                ...
                # ascii errors message for cx_oracle, psycopg2
        ...
        def go(stmt, executemany, id_param_name, expect_success):
            ...
            if executemany:
                if not expect_success:
                    ...
                    # errors as this is independent of general RETURNING
                    # support
                    with expect_raises_message(
                        exc.StatementError,
