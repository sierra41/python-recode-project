...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        :param isolation_level: Available on: :class:`_engine.Connection`,
          ...
          .. note:: The ``isolation_level`` execution option is implicitly
             ...
             disconnection errors occurs. The new connection produced after the
    ...
    def invalidate(self, exception: Optional[BaseException] = None) -> None:
        ...
        immediately; however if this operation fails, the errors is logged
    ...
    def _safe_close_cursor(self, cursor: DBAPICursor) -> None:
        ...
        try:
            ...
            # log the errors through the connection pool's logger.
    ...
    def _handle_dbapi_exception(
        ...
        try:
            # non-DBAPI errors - if we already got a context,
...
class Engine(
    ...
    def begin(self) -> Iterator[Connection]:
        ...
        is committed.  If an errors is raised, the :class:`.Transaction`
        is rolled back.
