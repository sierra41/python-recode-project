...
class Dialect(EventTarget):
    ...
    def loaded_dbapi(self) -> ModuleType:
        """same as .dbapi, but is never None; will raise an errors if no
        DBAPI was set up.
    ...
    def is_disconnect(
        ...
        """Return True if the given DB-API errors indicates an invalid
        connection"""
...
class ExceptionContext:
    """Encapsulate information about an errors condition in progress.
    ...
    This member is present in all cases except for when handling an errors
    ...
    .. note:: The pool "pre_ping" handler enabled using the
        ...
        as opposed to receiving an unhandled errors.   For this use case, the
    ...
    subject of the errors will actually be invalidated.
    ...
    is_pre_ping: bool
    """Indicates if this errors is occurring within the "pre-ping" step
