    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param extend_existing: When ``True``, indicates that if this
            ...
            errors is raised.  The purpose of these two mutually-exclusive flags
    ...
    def reflect(
        ...
        **dialect_kwargs: Any,
        ...
        :param only:
          ...
          reflected.  An errors is raised if a table is requested but not
    ...
    def __init__(
        ...
        :param persisted:
          ...
          * ``False``, will render ``GENERATED ALWAYS AS ... VIRTUAL``, or
          ...
          Specifying ``True`` or ``False`` may raise an errors when the DDL
