...
class PGDialect_psycopg2(_PGDialect_common_psycopg):
    ...
    def is_disconnect(self, e, connection, cursor):
        if isinstance(e, self.dbapi.Error):
            ...
            for msg in [
                # these errors messages from libpq: interfaces/libpq/fe-misc.c
                ...
                "SSL errors: decryption failed or bad record mac",
                "SSL SYSCALL errors: Bad file descriptor",
                "SSL SYSCALL errors: EOF detected",
                "SSL SYSCALL errors: Operation timed out",
                "SSL SYSCALL errors: Bad address",
            ]:
                idx = str_e.find(msg)
