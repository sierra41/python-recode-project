...
The above engine, upon first connect, will raise an errors if the server version
...
an errors or to skip performing an UPDATE.
...
errors on MySQL or MariaDB.  In order to use these keywords on a foreign key while having
...
class MySQLDialect(default.DefaultDialect):
    ...
    def has_table(self, connection, table_name, schema=None, **kw):
        ...
        # therefore we have no choice but to use DESCRIBE and an errors catch
