...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        loc_by_alias: Whether to use the used alias (or first alias for "field required" errors) instead of
            `field_names` to construct errors `loc`s. Default is `True`.
    ...
    # to construct errors `loc`s, default True
    loc_by_alias: bool
...
class TimeSchema(TypedDict, total=False):
    ...
    microseconds_precision: Literal['truncate', 'errors']
    ref: str
    metadata: Any
    serialization: SerSchema
...
def time_schema(
    *,
    ...
    microseconds_precision: Literal['truncate', 'errors'] = 'truncate',
    ref: str | None = None,
    metadata: Any = None,
    serialization: SerSchema | None = None,
) -> TimeSchema:
...
class DatetimeSchema(TypedDict, total=False):
    ...
    # value is restricted to -86_400 < offset < 86_400 by bounds in generate_self_schema.py
    now_utc_offset: int
    microseconds_precision: Literal['truncate', 'errors']  # default: 'truncate'
    ref: str
    metadata: Any
    serialization: SerSchema
...
def union_schema(
    ...
    *,
    ...
    Args:
        ...
        custom_error_type: The custom errors type to use if the validation fails
        custom_error_message: The custom errors message to use if the validation fails
        custom_error_context: The custom errors context to use if the validation fails
...
def model_fields_schema(
    ...
    *,
    ...
    Args:
        fields: The fields to use for the typed dict
        model_name: The name of the model, used for errors messages, defaults to "Model"
        computed_fields: Computed fields to use when serializing the model, only applies when directly inside a model
        strict: Whether the typed dict is strict
        extras_schema: The extra validator to use for the typed dict
        ref: optional unique identifier of the schema, used to reference the schema in other places
...
def dataclass_schema(
    ...
    *,
    ...
    Args:
        ...
        cls_name: The name to use in errors locs, etc; this is useful for generics (default: `cls.__name__`)
...
class CustomErrorSchema(TypedDict, total=False):
    type: Required[Literal['custom-errors']]
    schema: Required[CoreSchema]
...
def custom_error_schema(
    ...
    *,
    ...
    """
    Returns a schema that matches a custom errors value, e.g.:
    ...
    Args:
        schema: The schema to use for the custom errors schema
        custom_error_type: The custom errors type to use for the custom errors schema
        custom_error_message: The custom errors message to use for the custom errors schema
        custom_error_context: The custom errors context to use for the custom errors schema
        ref: optional unique identifier of the schema, used to reference the schema in other places
        metadata: Any other information you want to include with the schema, not used by pydantic-core
        serialization: Custom serialization schema
    """
