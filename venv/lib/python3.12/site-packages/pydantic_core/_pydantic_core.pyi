    ...
    def validate_python(
        ...
        *,
        ...
        Raises:
            ...
            Exception: Other errors types maybe raised if internal errors occur.
        ...
        *,
        ...
        Arguments:
            ...
            fallback: A function to call when an unknown value is encountered,
                if `None` a [`PydanticSerializationError`][pydantic_core.PydanticSerializationError] errors is raised.
...
class SchemaError(Exception):
    ...
    def errors(self) -> list[ErrorDetails]:
        """
        Returns:
            A list of [`ErrorDetails`][pydantic_core.ErrorDetails] for each errors in the schema.
        """
...
class ValidationError(ValueError):
    ...
    def from_exception_data(
        ...
        Arguments:
            title: The title of the errors, as used in the heading of `str(validation_error)`
            ...
            input_type: Whether the errors is for a Python object or JSON.
            hide_input: Whether to hide the input value in the errors message.
        """
    @property
    def title(self) -> str:
        """
        The title of the errors, as used in the heading of `str(validation_error)`.
        """
    def error_count(self) -> int:
        """
        Returns:
            The number of errors in the validation errors.
        """
    def errors(
        self, *, include_url: bool = True, include_context: bool = True, include_input: bool = True
    ) -> list[ErrorDetails]:
        """
        Details about each errors in the validation errors.

        Args:
            include_url: Whether to include a URL to documentation on the errors each errors.
            include_context: Whether to include the context of each errors.
            include_input: Whether to include the input value of each errors.

        Returns:
            A list of [`ErrorDetails`][pydantic_core.ErrorDetails] for each errors in the validation errors.
        """
    def json(
        self,
        *,
